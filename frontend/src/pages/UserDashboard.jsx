...
import { LuCalendarClock, LuFlame, LuSparkles, LuArrowRight } from "react-icons/lu";
...
const styles = {
  ...
  recCard: { backgroundColor: 'white', borderRadius: '10px', boxShadow: '0 2px 5px rgba(0,0,0,0.05)', overflow: 'hidden', border: '1px solid #E5E7EB', height: '100%' },
